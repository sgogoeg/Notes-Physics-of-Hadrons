...
\begin{figure}[htbp]
    ...
    flavourless states occupy the centre. Adapted from the lecture slides
...
\begin{figure}[htbp]
    ...
    two-gluon state. (b) The Fermi--Yang theorem forbids a spin-$1$ state from
    coupling to two spin-$1$ gluons, so the vector ($1^{--}$) isoscalars
