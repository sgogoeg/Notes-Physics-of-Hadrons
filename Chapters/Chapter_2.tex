...
% --- replaces the strange-particle FIGURE SUGGESTION in "Hadron discovery at accelerators"
\begin{figure}[t]
    \centering
...
\begin{figure}[t]
    ...
    centre. Right: the spin-$\tfrac{1}{2}$ baryon octet ($qqq$), with $\Sigma^0$ and
    $\Lambda$ at the centre.}
