...
\begin{figure}[t]
    ...
    minimum-ionising region. Right: $dE/dx$ versus momentum for $\mu$, $\pi$, $K$,
...
\begin{figure}[t]
    ...
    function of centre-of-mass energy, for the spin hypotheses $s_\pi = 0, 1, 2$.
...
\begin{figure}[t]
    ...
    \caption{$\mathrm{SU}(3)_f$ weight diagrams in the $(I_3, S)$ plane. Left: the
