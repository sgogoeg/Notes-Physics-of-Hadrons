...
\begin{figure}[htbp]
  ...
  wave function, and are therefore totally symmetric under exchange. Adapted
...
\begin{figure}[htbp]
  ...
  angular momentum $L_{3q}$ and band number $N = 2n + L$, with the established
...
\begin{figure}[htbp]
  ...
  sits on the plateaux predicted by $R = N_c\sum_q e_q^2$, requiring $N_c=3$.
